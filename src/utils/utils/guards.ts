...
export const isLineTypeArray = (
	unknown: LineType[] | LineType,
): unknown is LineType[] => Array.isArray(unknown);

export const isLineArray = (unknown: LineType): unknown is LineArrayElement[] =>
	Array.isArray(unknown);

export const isAttributeArray = (
	unknown: Attributes,
): unknown is AttributeArrayElement[] => Array.isArray(unknown);
