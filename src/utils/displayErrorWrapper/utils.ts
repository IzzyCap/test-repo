...
export const showLink = (stackCall: string[]): boolean =>
	stackCall.length > 1 && showVSCodeLink(stackCall[1]) && !!dirName();
export const dirName = () =>
	process.env.DIRNAME || process.env.REACT_APP_DIRNAME || null;
const showVSCodeLink = (path: string) =>
...
export const prepareComponentStack = (
